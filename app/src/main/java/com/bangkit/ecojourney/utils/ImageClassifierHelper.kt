...
class ImageClassifierHelper(
    ...
    fun classifyStaticImage(image: Uri) {
        ...
        val imageProcessor = ImageProcessor.Builder()
            .add(ResizeOp(180, 180, ResizeOp.ResizeMethod.NEAREST_NEIGHBOR))
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            val imageProcessingOptions = ImageProcessingOptions.builder()
                .setOrientation(getOrientationFromRotation(getRotationFromExif(image)))
                .build()
    ...
    private fun getRotationFromExif(imageUri: Uri): Int {
        var rotation = 0
        try {
